	...
	<div class="row">
		<div class="col-lg-3 col-sm-12">
			...
			<ul id="accordion" class="accordion">
					  		...
					  		<li>  			
					    		<div class="link"><a href="/employers/orders?page=1&category_id=<?php echo $val['id']?>"><?php echo $val['name']?></a>
					    		</div>	
		...
		<div class="col-lg-9 col-sm-12 employers-block mt-2">
			...
			<div class="employer-block__item mt-5">
				<h4><a href="/employers/order/id=<?php echo $order['id']?>"><?php echo $order['title'];?></a></h4>
				<div class="employer-block__header">
					<?php if($user['id'] == $order['id_employer']):?>
					<a href="/employer/<?php echo $user['login']?>"><?php echo $user['login']?></a>
					<?php foreach($category as $val):?>
						<?php if($user['id_category'] == $val['id']):?>
